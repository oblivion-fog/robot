...
#include "my_robot_interfaces/srv/detail/addthree_ints__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_robot_interfaces::srv::AddthreeInts_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_robot_interfaces::srv::AddthreeInts_Request & ros_message)
{
  // Member: a
  cdr >> ros_message.a;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_robot_interfaces::srv::AddthreeInts_Request;
    is_plain =
      (
      offsetof(DataType, c) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const my_robot_interfaces::srv::AddthreeInts_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_robot_interfaces::srv::AddthreeInts_Request *>(
    untyped_ros_message);
...
{
  return &my_robot_interfaces::srv::typesupport_fastrtps_cpp::_AddthreeInts_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, srv, AddthreeInts_Request)() {
  return &my_robot_interfaces::srv::typesupport_fastrtps_cpp::_AddthreeInts_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_my_robot_interfaces
cdr_serialize(
  const my_robot_interfaces::srv::AddthreeInts_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: sum
  cdr << ros_message.sum;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_robot_interfaces::srv::AddthreeInts_Response & ros_message)
{
  // Member: sum
  cdr >> ros_message.sum;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_robot_interfaces::srv::AddthreeInts_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_robot_interfaces::srv::AddthreeInts_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<my_robot_interfaces::srv::AddthreeInts_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &my_robot_interfaces::srv::typesupport_fastrtps_cpp::_AddthreeInts_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, srv, AddthreeInts_Response)() {
  return &my_robot_interfaces::srv::typesupport_fastrtps_cpp::_AddthreeInts_Response__handle;
}
...
{
  return &my_robot_interfaces::srv::typesupport_fastrtps_cpp::_AddthreeInts__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, srv, AddthreeInts)() {
  return &my_robot_interfaces::srv::typesupport_fastrtps_cpp::_AddthreeInts__handle;
}
