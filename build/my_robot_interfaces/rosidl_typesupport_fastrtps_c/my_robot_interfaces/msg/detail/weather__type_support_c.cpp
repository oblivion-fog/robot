...
#include "my_robot_interfaces/msg/detail/weather__rosidl_typesupport_fastrtps_c.h"
...
using _Weather__ros_msg_type = my_robot_interfaces__msg__Weather;
...
size_t get_serialized_size_my_robot_interfaces__msg__Weather(
  const void * untyped_ros_message,
...
static uint32_t _Weather__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_robot_interfaces__msg__Weather(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_interfaces
size_t max_serialized_size_my_robot_interfaces__msg__Weather(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_robot_interfaces__msg__Weather;
    is_plain =
      (
...
static size_t _Weather__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_robot_interfaces__msg__Weather(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_robot_interfaces, msg, Weather)() {
